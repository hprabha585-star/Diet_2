/* ============================================================
   FastCoach — 55-Day Step-by-Step Fasting Protocol (master data)
   Transcribed from the coach's protocol document. This is only the
   DEFAULT: once seeded into MongoDB the coach can edit any day from
   Admin console -> 55-day protocol.
